      ...
      <a-col :span="16">
        ...
        <a-tabs type="card" v-model:activeKey="currentKey">
            ...
            <a-row type="flex" justify="center">
              <a-col :span="12">
                ...
                <a-form :model="form" :rules="rules" ref="publishForm" layout="vertical">
                  ...
                  <a-form-item>
                    <a-button type="primary" @click="update" size="large" :loading="status.loading && status.opName === 'login'">
          ...
          <a-tab-pane key="recover" tab="恢复删除作品">
            <a-table :columns="tableColumns" :data-source="works" rowKey="id" :pagination="pagination" @change="handleTableChange" :loading="loading">
