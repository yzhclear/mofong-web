  ...
  <div class="homepage-container">
    ...
    <div class="content-container">
      <a-row class="content-title" type="flex" align="middle">
        ...
        <a-button shape="circle" size="small" v-if="currentSearchText" :style="{ marginLeft: '10px' }" @click="clearSearch"> × </a-button>
      ...
      <a-row type="flex" justify="center">
        <a-button type="primary" size="large" @click="loadMorePage" v-if="!isLastPage" :loading="loading"> 加载更多 </a-button>
      </a-row>
...
export default defineComponent({
  ...
  setup() {
    ...
    const testData = computed(() => store.state.works.templates);
